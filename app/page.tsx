...
export default function Home() {
  return (
    <main className="relative z-10 bg-dark min-h-screen text-gray-200 selection:bg-primary selection:text-white">
          ...
          <div className="flex items-center justify-between h-24">
            <div className="flex-shrink-0 flex items-center gap-4">
              ...
              <img 
                src="/logo.png" 
                alt="Deja Vu Logo" 
                className="h-20 w-auto object-contain filter drop-shadow-[0_0_5px_rgba(209,86,17,0.5)]" 
              />
              {/* Texto Logo */}
              <span className="font-display font-bold text-3xl text-primary tracking-widest uppercase bg-clip-text text-transparent bg-gradient-to-r from-primary via-primary-light to-primary drop-shadow-sm hidden sm:block">
                Deja Vu
              </span>
            </div>
            <div className="hidden md:block">
              <div className="ml-10 flex items-center space-x-12">
                ...
                <a className="px-8 py-3 border border-primary/50 text-primary hover:bg-primary hover:text-white transition-all duration-500 font-mono text-xs font-bold uppercase tracking-[0.2em]" href="#booking">
                  Agendar Cita
                </a>
              </div>
            </div>
            <div className="-mr-2 flex md:hidden">
              <button className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-white/10 focus:outline-none" type="button">
      ...
      {/* --- HERO SECTION --- */}
      <header className="relative h-[85vh] min-h-[600px] flex flex-col items-center justify-start pt-72 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto flex flex-col items-center">
          <div className="mb-8 opacity-90 drop-shadow-[0_0_15px_rgba(209,86,17,0.3)]">
             <h2 className="text-2xl font-mono text-primary tracking-[0.5em] uppercase border-b border-primary/50 pb-2">Body Art</h2>
          </div>

          <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-black text-white mb-6 tracking-wide leading-tight drop-shadow-2xl">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl md:text-2xl text-gray-300 font-serif italic mb-12 border-l-2 border-primary/50 pl-6 text-left leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center w-full">
            <a className="group relative px-10 py-4 bg-transparent overflow-hidden rounded-none min-w-[200px] border border-primary/30" href="#booking">
            ...
            <a className="text-gray-400 hover:text-white text-sm font-mono uppercase tracking-[0.2em] transition-colors border-b border-transparent hover:border-primary pb-1" href="#gallery">
              Ver Portafolio
            </a>
          </div>
        </div>
        
        {/* Flecha de scroll - BAJADA MÁS (bottom-4) */}
      ...
      {/* --- GALERÍA --- */}
      <section className="py-32 bg-dark relative" id="gallery">
      ...
      {/* --- SUMINISTROS --- */}
      <section className="py-32 bg-surface relative overflow-hidden" id="supplies">
      ...
      {/* --- ROPA / APPAREL --- */}
      <section className="py-32 bg-dark border-t border-white/5" id="apparel">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* --- BOOKING / CONTACTO --- */}
      <section className="relative py-32 bg-secondary overflow-hidden" id="booking">
        {/* Fondo sutil */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 w-full">
              <div className="bg-dark/80 backdrop-blur-md p-10 border border-primary/30 shadow-2xl relative">
